...
class Client:
	...
	def exitClient(self):
		...
		# Close window
		self.master.destroy()
		cache_file = os.path.join(CACHE_FILE_NAME + str(self.sessionId) + CACHE_FILE_EXT)
		# Delete cache.
	...
	def connectToServer(self):
		...
		try:
			...
			tkinter.messagebox.showerror("lỗi", f"Kết nối tới {self.serverAddr} thất bại.")
	...
	def openRtpPort(self):
		...
		try:
			...
			tkinter.messagebox.showwarning('Fail', 'PORT=%d không thể bind' %self.rtpPort)
